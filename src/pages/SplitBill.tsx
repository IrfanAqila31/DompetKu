...
const SplitBill = ({ addTransaction }: Props) => {
  ...
  return (
    <main className="max-w-xl mx-auto py-2 px-0 md:px-4">
      <div className="mb-10">
        <p className="text-sm font-bold text-indigo mb-1.5 text-center md:text-left">
          Kalkulator Patungan
        </p>
        ...
        <div className="mb-2">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 text-center bg-white/2 rounded-xl py-2.5">
              <span className="text-xl font-black text-white">{people}</span>
      ...
      >
        <p className="text-sm font-bold text-indigo mb-3">Patungan Per Orang</p>
        <motion.div
          key={perPerson}
          initial={{ scale: 0.95, opacity: 0 }}
          animate={{ scale: 1, opacity: 1 }}
          className="text-2xl md:text-3xl font-black text-indigo tracking-tight mb-4"
        >
          {fmt(perPerson)}
        </motion.div>
